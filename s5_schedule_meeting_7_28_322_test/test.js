...
function testAddRooms() {
    ...
    host.setTimeout(function () {
        ...
        return Q.fcall(function () {
            ...
            assertOk((addRoomWindow !== null), "Test for clicking on Add rooms button");
...
function testMovingToYesterday() {
    ...
    host.setTimeout(function () {
        ...
        host.setTimeout(checkForDate("6/12/2015",
            "Test for moving to yesterday --> When input day is normal weekday and yesterday is a weekend", testAddRooms), 10000);
...
function testMovingToTomorrow() {
    ...
    host.setTimeout(function () {
        ...
        host.setTimeout(function () {
            ...
            // Unit testing
            assertStrictEqual(narratorSentence, "You've selected a weekend. Please select a weekday.",
                "Test for moving to tomorrow --> When the input day is a weekend");
    ...
    host.setTimeout(function () {
        ...
        host.setTimeout(function () {
            ...
            assertStrictEqual(narratorSentence, "You have no previous suggestions.",
                "Test for reading out --> no previous suggestions when user presses UP key");
...
function testClickingOnSAButton() {
    ...
    host.setTimeout(function () {
        ...
        assertStrictEqual(narratorSentence, "Make sure you have pressed 8 to start reading suggested times. ",
            "Test for if the Narrator is checking whether user has pressed 8 or not for reading out suggestions - Press UP");
        ...
        host.setTimeout(function () {
            ...
            assertStrictEqual(narratorSentence, "Make sure you have pressed 8 to start reading suggested times. ",
                "Test for if the Narrator is checking whether user has pressed 8 or not for reading out suggestions - Press DOWN");
