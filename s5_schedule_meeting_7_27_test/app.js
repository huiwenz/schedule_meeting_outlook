                        ...
                        if (firstDayPrevWeek != null) {
                            ...
                            if (firstDayPrevWeek.name === "Su") { // We need to switch back to previous month
                                ...
                                .then(function (prevTargetDay) {
                                    ...
                                    console.log("SHOULD FIND: " + prevTargetDay.name);
            ...
            if (previousSib != null) {
                ...
                return Q.fcall(function () {
                    ...
                    if (nextSib == null) {
                        ...
                        }, function (error) { throw new Error("The promise for finding the invoke pattern for next day fails."); });
                    }
...
// The function which wraps the operation of adding rooms
function addRoomsWrapper() {
